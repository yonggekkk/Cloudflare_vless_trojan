...
menu() {
   ...
   green "当前脚本版本：V25.1.6  快捷方式：bash serv00.sh"
   echo "再过几天，脚本将迁移至https://github.com/yonggekkk/sing-box-yg项目，脚本地址将正式变更:"
   echo "bash <(curl -Ls https://raw.githubusercontent.com/yonggekkk/sing-box-yg/main/serv00.sh)"
   echo "========================================================="
   green  "1. 安装sing-box"
   echo   "---------------------------------------------------------"
   red    "2. 卸载sing-box"
