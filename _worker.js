...
function getVLESSConfig(userID, hostName) {
	const wvlessws = `vless://${userID}@www.web.com:8880?encryption=none&security=none&type=ws&host=${hostName}&path=%2F%3Fed%3D2048#${hostName}`;
	const pvlesswstls = `vless://${userID}@www.web.com:8443?encryption=none&security=tls&type=ws&host=${hostName}&sni=${hostName}&fp=random&path=%2F%3Fed%3D2048#${hostName}`;
