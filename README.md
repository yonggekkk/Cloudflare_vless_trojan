...
### 小白们注意：以电脑端V2rayN为例，唯一标准是右下角 "当前延迟：-1 ms" 时，才能说明选择的节点不可用
...
1、workers的变量更改会自动刷新。pages的变量更改好后，必须点击右上角创建部署选项，重新上传一次原始pages文件来使新变量生效pages部署好后，其域名要等1分钟才能生效打开

2、ip1到ip7，pt1到pt7，在订阅分享链接中，仅支持80系端口关TLS节点

3、ip8到ip13，pt8到pt13，在订阅分享链接中，仅支持443系端口开TLS节点

4、单节点可随意DIY修改并无限克隆节点，具体见相关[手搓节点的视频教程](https://youtu.be/WwAeLyEz6jY)
