...
2、苹果手机用户，由于ISH最新版有BUG导致脚本运行卡住，请使用ISH_1.2.2版本：安装包已上传到项目目录https://github.com/yonggekkk/Cloudflare_vless_trojan/tree/main/ISH_1.2.2 大家自行下载

可配合电脑端爱思助手连接苹果手机，把IPA安装包直接拖到爱思助手应用栏中即可自动安装到苹果手机上
